...
4. **Content Structure**: Verse Builder content is exactly **15 chapters × 8 verses = 120 levels**, and every verse must supply reference, hint, cheer, and non-empty text in all 4 translations. Every character key must have an avatar configuration in `Buddy.jsx`.
