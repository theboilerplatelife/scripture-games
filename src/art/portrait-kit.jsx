...
export const PEOPLE = {
  ...
  /* Additional characters for Who Am I */
  adam:      { skin: "#c88a56", hair: "#3d2b1f", curly: true, beard: "#3d2b1f", brow: "#291a11", robe: "#5c8a3a" },
  eve:       { skin: "#eac59c", hair: "#6b4a33", beard: null, brow: "#42281a", robe: "#8a6bbf" },
  noah:      { skin: "#dfb088", hair: "#e0ded9", beard: "#edeae3", brow: "#8a857b", robe: "#3e7cb1" },
  abraham:   { skin: "#d5a173", hair: "#f0ede6", curly: true, beard: "#f8f5ee", brow: "#999285", robe: "#b08d57" },
  sarah:     { skin: "#e3ad81", hair: "#e0ded9", beard: null, brow: "#706a5f", robe: "#588157", hood: "#9fd4ef" },
  jacob:     { skin: "#c9854e", hair: "#4b382a", beard: "#4b382a", brow: "#362114", robe: "#9c6644" },
  joseph:    { skin: "#dfae7c", hair: "#2e1e14", curly: true, beard: null, brow: "#241e1c", robe: "#ffb703" },
  miriam:    { skin: "#c98a54", hair: "#3d2b1f", beard: null, brow: "#33241a", robe: "#d94f30", hood: "#e88b6a" },
  rahab:     { skin: "#daa06d", hair: "#2e1e14", beard: null, brow: "#291a11", robe: "#c14953", hood: "#c14953" },
  gideon:    { skin: "#e2ab7d", hair: "#4a3524", curly: true, beard: "#4a3524", brow: "#33241a", robe: "#b08d57" },
  samson:    { skin: "#d99a68", hair: "#3a2e2b", curly: true, beard: "#3a2e2b", brow: "#241e1c", robe: "#7b2cbf" },
  ruth:      { skin: "#eac59c", hair: "#593d2b", beard: null, brow: "#42281a", robe: "#f4a261", hood: "#b08d57" },
  samuel:    { skin: "#e6ba94", hair: "#cfcac0", beard: "#e8e4dc", brow: "#8f887b", robe: "#5c8a3a" },
  elijah:    { skin: "#c88a56", hair: "#e0ded9", curly: true, beard: "#edeae3", brow: "#8a857b", robe: "#d94f30" },
  elisha:    { skin: "#dfb088", bald: true, hair: "#e0ded9", beard: "#edeae3", brow: "#8a857b", robe: "#3e7cb1" },
  naaman:    { skin: "#e8bd93", hair: "#4b382a", beard: "#4b382a", brow: "#7c3f21", robe: "#1d3557" },
  esther:    { skin: "#e2ab7d", hair: "#2e1e14", beard: null, brow: "#241e1c", robe: "#8a6bbf", crown: true },
  daniel:    { skin: "#dfae7c", hair: "#6b4226", curly: true, beard: "#6b4226", brow: "#472813", robe: "#b08d57" },
  jonah:     { skin: "#d59254", hair: "#533e2d", beard: "#533e2d", brow: "#38271a", robe: "#3e7cb1" },
  mary:      { skin: "#e6ba94", hair: "#593d2b", beard: null, brow: "#42281a", robe: "#e88b6a", hood: "#3a86ff" },
  john_baptist: { skin: "#c98a54", hair: "#3a2e2b", curly: true, beard: "#3a2e2b", brow: "#241e1c", robe: "#c98a4b" },
  stephen:   { skin: "#d5a173", hair: "#4a3524", beard: "#4a3524", brow: "#33241a", robe: "#8a6bbf" },
};
